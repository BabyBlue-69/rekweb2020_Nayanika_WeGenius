...
<body class="home page-template page-template-blank page">
    ...
    <div class="section">
        <div class="hoverable">
            <div><img src="../../img/produk/zfold2-01.jpeg">
                <!-- <div class="content">
                    ...
                    <table class="table table-hover">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>Foldable Dynamic AMOLED 2X, HDR10+</td>
                                <td>Cover : 6.23', Inside : 7.6'</td>
                                <td>816 X 2260, 1768 X 2208 (373 ppi) </td>
                            </tr>
                            <tr>
