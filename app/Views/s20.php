...
<body class="home page-template page-template-blank page">
  ...
  <div class="section">
    <div class="hoverable">
      <div><img src="../../img/produk/s20produk co0pi.jpg">
        <!-- <div class="content">
          ...
          <table class="table table-hover">
            ...
            <tbody>
              <tr>
                ...
                <td>Dynamic AMOLED+, HDR 10+</td>
                <td>6,9'</td>
                <td>1440 x 3200 (511 ppi)</td>
              </tr>
              <tr>
                <th scope="row"> 📷 Kamera</th>
                <td>108 MP (Wide)</td>
                <td>48 MP (periscope telephoto)</td>
              ...
              <tr>
                ...
                <td colspan="2">Li-Ion 5000mAh</td>
